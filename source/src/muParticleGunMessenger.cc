...
muParticleGunMessenger::muParticleGunMessenger(muParticleGun *pg)
    ...
    parCmd->SetGuidance(
            "Select particle 0:User 1:neutron 2:mu- 3:Random flux neutron 4:Real neutron spectrum 5:fission(Cf) 6:positron(Na-22), 7:2gamma(Ps), 8:3gamma(Ps) 9:gamma 1275keV");
